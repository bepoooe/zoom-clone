...
const Sidebar = () => {
  ...
  return (
    <section className="sticky left-0 top-0 flex h-screen w-fit flex-col justify-between bg-brand-black-950 border-r border-brand-black-800 p-6 pt-28 text-white max-sm:hidden lg:w-[264px]">
